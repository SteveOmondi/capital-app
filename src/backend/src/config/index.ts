...
export const config = {
  ...
  services: {
    capitalFmApiBaseUrl: process.env.CAPITALFM_PUBLIC_API_BASE_URL || 'https://capitalfm.africa/wp-json/capitalfm/v1',
    wpCmsBaseUrl: process.env.WP_CMS_BASE_URL || 'https://capitalfm.africa/wp-json/capitalfm/v1',
    ...
    liveStreamFallbackUrl: sanitizeStreamUrl(process.env.LIVE_STREAM_FALLBACK_URL, 'https://atunwadigital.streamguys1.com/capitalfm/playlist.m3u8'),
